	  ...
	  <div id="wrapper">																																																																											
		<div id="content_inside">
          <div id="sidebar">
				...
				<ul id="list">
					<li class="color2_active"><a href="lr.php">Living Room&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
		  ...
		  <?php
				...
				{
					$result = mysql_query("SELECT * FROM products where Category = 'LIVING ROOM'");
				}
				while($row=mysql_fetch_assoc($result))
				{
					...
					<hr>
					<h3>'.$row['Product'].'</h3>
					<img src="images/products/1/'.$row['ID'].'.jpg" width="210" height="210" alt="image"/>
