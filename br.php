		...
		<div id="content_inside">
          <div id="sidebar">
				...
				<ul id="list">
					...
					<li><a style="text-decoration:none">&nbsp;</a></li>
					<li class="color2_active"><a href="br.php">Bed Room&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
					<li><a style="text-decoration:none">&nbsp;</a></li>
		  ...
		  <?php
				...
				{
					$result = mysql_query("SELECT * FROM products where Category like 'BEDROOM'");
				}
				while($row=mysql_fetch_assoc($result))
				{
					...
					<hr>
					<h3>'.$row['Product'].'</h3>
					<img src="images/products/3/'.$row['ID'].'.jpg" width="210" height="210" alt="image"/>
